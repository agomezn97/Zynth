...
architecture STRUCTURE of NCA is
  ...
  signal i_En_LFO_1 : STD_LOGIC;
  signal i_FTW_0_1 : STD_LOGIC_VECTOR ( 23 downto 0 );
  signal i_NoteOn_0_1 : STD_LOGIC;
...
begin
  B_0_1(15 downto 0) <= i_NoteIn(15 downto 0);
  i_ADSR_Param_0_1(15 downto 0) <= i_ADSR_Param(15 downto 0);
  i_Amp_0_1(7 downto 0) <= i_Amp_LFO(7 downto 0);
  i_Clk_0_1 <= i_MCLK;
  i_En_LFO_1 <= i_En_LFO;
  i_FTW_0_1(23 downto 0) <= i_FTW_LFO(23 downto 0);
  i_NoteOn_0_1 <= i_NoteOn;
  i_WaveSelect_0_1(1 downto 0) <= i_WaveSel_LFO(1 downto 0);
  o_NCA_Note(15 downto 0) <= mult_gen_0_P(15 downto 0);
