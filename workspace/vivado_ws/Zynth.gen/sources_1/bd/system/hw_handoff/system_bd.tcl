...
# module references:
# Debounce_Switch, Debounce_Switch, Debounce_Switch, Debounce_Switch, I2S_Tx, Note_Config, Note_Driver, Note_Generator
...
proc create_root_design { parentCell } {
  ...
  set NCA_0 [ create_bd_cell -type ip -vlnv rtlogik:user:NCA:1.0 NCA_0 ]
  ...
  set block_name Note_Config
  set block_cell_name Note_Config_0
  if { [catch {set Note_Config_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Note_Config_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net i_Sw0_0_1 [get_bd_ports sw0] [get_bd_pins Note_Config_0/i_Sw0]
  connect_bd_net -net i_Sw1_0_1 [get_bd_ports sw1] [get_bd_pins Note_Config_0/i_Sw1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports MCLK] [get_bd_pins Debounce_Switch_0/i_Clk] [get_bd_pins Debounce_Switch_1/i_Clk] [get_bd_pins Debounce_Switch_2/i_Clk] [get_bd_pins Debounce_Switch_3/i_Clk] [get_bd_pins I2S_Tx_0/i_MCLK] [get_bd_pins NCA_0/i_MCLK] [get_bd_pins Note_Driver_0/i_Clk] [get_bd_pins Note_Generator_0/i_Clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
