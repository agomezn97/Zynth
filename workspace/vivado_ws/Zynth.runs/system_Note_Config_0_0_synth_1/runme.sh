...
HD_PWD='C:/Users/anton/Desktop/RTLogik/Repositories/Zynth/workspace/vivado_ws/Zynth.runs/system_Note_Config_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Note_Config_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Note_Config_0_0.tcl
