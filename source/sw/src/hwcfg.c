...
void interrupt_init(void)
{
	...
	ICDIPTR14 = 0x01000000;  // Set interrupts processor target to CPU1
	ICDIPTR15 = 0x01010100;  // Set interrupts processor target to CPU0
	ICDICFR3  = 0xFCC00000;  // Set interrupt sensitivity (rising-edge)
	ICDDCR    = 0x3;         // Enable non-secure interrupts
	ICDISER1  = 0xE8000000;  // Set-enable interrupt sources
}
