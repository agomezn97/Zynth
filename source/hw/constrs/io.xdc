...
set_property PACKAGE_PIN V17 [get_ports {GPIO_EMIO_tri_io[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_EMIO_tri_io[5]}]
set_property PACKAGE_PIN V18 [get_ports {GPIO_EMIO_tri_io[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {GPIO_EMIO_tri_io[6]}]
set_property PACKAGE_PIN T16 [get_ports {GPIO_EMIO_tri_io[7]}]
set_property PACKAGE_PIN R17 [get_ports {GPIO_EMIO_tri_io[8]}]
